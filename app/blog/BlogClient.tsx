...
// Los artículos llegan del SERVIDOR (app/blog/page.tsx los trae de Supabase y
// los pasa como props) → el listado completo va en el HTML inicial, crawlable
// por Google y por agentes de IA. Antes: fetch en useEffect + gate `mounted`
// que hacía que el SSR devolviera null (blog invisible para crawlers).
export function BlogClient({ initialArticles }: { initialArticles: any[] }) {
    const [dbArticles] = useState<any[]>(initialArticles);
