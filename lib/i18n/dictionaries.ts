...
const es = {
    ...
    brands: {
        ...
        titleItalic: "marcas",
        title2Pre: "que cambian su",
        title2Underlined: "industria",
        stat1: "10+ marcas",
        stat2: "8 industrias",
        stat3: "2020 — 2026",
    },
    ...
    testimonials: {
        item1: {
            ...
            quotePre: "El ",
            quoteUnder1: "salto de calidad",
            quoteMid1: " con la web 3D fue el ",
            quoteItalic1: "catalizador",
            quoteMid2:
                " que necesitábamos. El reconocimiento de la marca se ha disparado; no solo vimos un aumento del ",
            quoteChip1: "+600%",
            quoteMid3: " en el engagement de redes sociales, sino que logramos entrar en los ",
            quoteBold1: "estantes de los principales distribuidores nacionales",
            quoteMid4:
                " en tiempo récord. La web se ve increíble y proyecta una solidez tal que, en las reuniones de ventas, los ",
            quoteItalic2: "compradores ya vienen convencidos",
            quotePost: ". No podríamos estar más emocionados con el resultado.",
            name: "CARLOS R.",
        ...
        item2: {
            ...
            quotePre: "Nuestro concepto ha tenido una adopción masiva, impulsada por una experiencia web ",
            quoteItalic1: "inmersiva, audaz y llamativa",
            quoteMid1: " que nos hizo ",
            quoteBold1: "reconocibles al instante",
            quoteMid2: " en un ",
            quoteUnder1: "mercado saturado",
            quoteMid3: ". Más allá de lo visual, el sistema de marca integrado nos ha permitido ",
            quoteChip1: "escalar con agilidad",
            quoteMid4:
                " hacia nuevas audiencias. La navegación es tan fluida que el usuario se sumerge en nuestra propuesta de valor ",
            quoteItalic2: "sin fricciones",
            quotePost: ". Estamos extremadamente contentos con el resultado.",
            name: "RAQUEL S.",
        ...
        item3: {
            ...
            quotePre: "El lanzamiento de nuestra nueva landing page marcó un ",
            quoteItalic1: "antes y un después",
            quoteMid1: " en nuestra estrategia comercial. Pasamos de tener visitas pasivas a generar ",
            quoteChip1: "leads de alta calidad",
            quoteMid2:
                " de forma constante. No se trata solo de que el diseño sea impactante y moderno, es que la estructura está tan bien optimizada que la ",
            quoteUnder1: "conversión de nuevos clientes se duplicó",
            quoteMid3: " en el ",
            quoteBold1: "primer mes",
            quoteMid4: ". Ha sido la herramienta clave para que el mercado entienda nuestro valor real y el ",
            quoteItalic2: "crecimiento ha sido inmediato",
            quotePost: ".",
            name: "ESTEBAN C.",
    ...
    whatsapp: {
        openWhatsApp: "Escríbenos por WhatsApp",
        openEmail: "Escríbenos por correo",
...
const en: typeof es = {
    ...
    brands: {
        ...
        title1: "Built for",
        titleItalic: "brands",
        title2Pre: "that reshape their",
        title2Underlined: "industry",
        stat1: "10+ brands",
        stat2: "8 industries",
        stat3: "2020 — 2026",
    },
    ...
    testimonials: {
        item1: {
            ...
            quotePre: "The ",
            quoteUnder1: "quality leap",
            quoteMid1: " with the 3D website was the ",
            quoteItalic1: "catalyst",
            quoteMid2: " we needed. Brand recognition has skyrocketed; we not only saw a ",
            quoteChip1: "+600%",
            quoteMid3: " increase in social media engagement, but we got onto the ",
            quoteBold1: "shelves of major national retailers",
            quoteMid4:
                " in record time. The site looks incredible and projects such solidity that, in sales meetings, ",
            quoteItalic2: "buyers already come convinced",
            quotePost: ". We couldn't be more thrilled with the result.",
            name: "CARLOS R.",
            role: "Co-Founder & President, NuRange Coffee",
            tags: ["Web Design"],
        },
        item2: {
            stat: "7x",
            subtitle: "PRODUCT EXPANSION",
            quotePre: "Our concept has seen massive adoption, driven by an ",
            quoteItalic1: "immersive, bold, and eye-catching",
            quoteMid1: " web experience that made us ",
            quoteBold1: "instantly recognizable",
            quoteMid2: " in a ",
            quoteUnder1: "saturated market",
            quoteMid3: ". Beyond the visuals, the integrated brand system has let us ",
            quoteChip1: "scale with agility",
            quoteMid4:
                " into new audiences. Navigation is so smooth that users immerse themselves in our value proposition ",
            quoteItalic2: "without friction",
            quotePost: ". We are extremely happy with the result.",
            name: "RAQUEL S.",
            role: "Founder & Owner, Escapely",
            tags: ["UX/UI", "Web Design"],
        },
        item3: {
            stat: "10x",
            subtitle: "QUALIFIED LEADS",
            quotePre: "The launch of our new landing page marked a ",
            quoteItalic1: "before and after",
            quoteMid1: " in our sales strategy. We went from passive visits to consistently generating ",
            quoteChip1: "high-quality leads",
            quoteMid2:
                ". It's not just that the design is striking and modern, it's that the structure is so well optimized that ",
            quoteUnder1: "new customer conversion doubled",
            quoteMid3: " in the ",
            quoteBold1: "first month",
            quoteMid4: ". It has been the key tool for the market to understand our real value, and the ",
            quoteItalic2: "growth has been immediate",
            quotePost: ".",
            name: "ESTEBAN C.",
            role: "Partner & Director, Butcher Bird",
            tags: ["Landing", "Web & Interactive", "Strategy"],
        },
    },
    whatsapp: {
        openWhatsApp: "Message us on WhatsApp",
        openEmail: "Email us",
