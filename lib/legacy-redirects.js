...
const LEGACY_EXACT_REDIRECTS = {
    // Portafolio es el único índice de proyectos; las páginas de caso se conservan.
    '/casos': '/portafolio',
    '/en/case-studies': '/en/portafolio',
    ...
    '/precio': PRICING_HUB,
    '/precios': PRICING_HUB,
    // '/contacto' ya NO va aquí: desde julio de 2026 es una página real
    // (app/contacto). Si se reintroduce la entrada, la redirección gana sobre la
    // página y esta deja de existir para Google sin que nada falle a la vista.
    // '/en/contacto' sí sigue aquí, pero ya no apunta a la home EN: desde que
    // existe app/en/contact manda a la página inglesa real (ver más abajo).
    ...
    // Ya existe página inglesa: la ruta vieja apunta a ella, no a la home EN.
    ...
    // Mismo caso: el contenido ya hablaba de 2026 (View Transitions, scroll-driven
    // animations) pero el slug se había quedado en 2025.
    '/blog/animaciones-web-tendencias-2025': '/blog/animaciones-web-tendencias-2026',
};
