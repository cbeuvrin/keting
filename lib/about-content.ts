...
export const COMPANY_ABOUT: { es: AboutLangContent; en: AboutLangContent } = {
    es: {
        ...
        workTitle: "Marcas distintas, retos propios",
        workBody:
    ...
    en: {
        ...
        workTitle: "Distinct brands, unique challenges",
        workBody:
...
export const AUTHOR_ABOUT: { es: AuthorAboutLangContent; en: AuthorAboutLangContent } = {
    es: {
        ...
        projectsTitle: "Marcas distintas, retos propios",
    ...
    en: {
        ...
        projectsTitle: "Distinct brands, unique challenges",
