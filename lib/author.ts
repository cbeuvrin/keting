// Datos del autor/fundador — fuente única para schema (E-E-A-T) y la caja de autor.
export const AUTHOR = {
    name: "Carlos Beuvrin",
    ...
    linkedin: "https://www.linkedin.com/in/carlos-fernando-beuvrin-rodriguez-520526222/",
    photo: "/carlos-beuvrin-avatar.png",
} as const;
